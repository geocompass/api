...
module.exports.tests.dedupe = function(test, common) {
  ...
  // postalcodes with same country_a but differing hierarchies should be considered same
  ...
  // postalcodes with same dependency_a but differing hierarchies should be considered same
